...
${ANDROID_NDK}/build/tools/make-standalone-toolchain.sh --platform=android-14 --install-dir=/tmp/temp-standalone-android-toolchain --toolchain=arm-linux-androideabi-4.9
